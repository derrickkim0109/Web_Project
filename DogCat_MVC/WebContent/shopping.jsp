	...
	<form action="shopping.cnd">
		<table align="center">
			<tr>
				...
				<td width="750"><input type="text" name="content" placeholder="입력해 주세요" size="30" /></td>
     		...
     		<tr>
     			<td colspan="7" align="center" >
     				<c:forEach  begin="1" end="${totalPage}" varStatus="status"> 	
						<a href="shoppingPaging.cnd?page=${status.count}">${status.count}</a>
					</c:forEach>
				</td>
			</tr>
    </tbody>
