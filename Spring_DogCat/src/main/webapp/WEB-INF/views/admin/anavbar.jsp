  ...
  <nav class ="container-fluid navbar-fixed-top">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="amember.cnd" style="align-self:  center;">회원 관리</a></li>
                <li><a href="aorder.cnd">주문내역 관리</a></li>
                <li><a href="aitems.cnd">상품 관리</a></li>
                <li><a href="apost.cnd">게시판 관리</a></li>
                <li><a href="anotice.cnd">공지사항 관리</a></li>
                <li><a href="aqna.cnd">QnA 관리</a></li>
            </ul>
           	<%
            ...
            <%
             ...
             %>
            		<ul class="nav navbar-nav navbar-right">              
                       	  <li><a href="admin.cnd" style="align-self:  center;">관리자메뉴</a></li>
